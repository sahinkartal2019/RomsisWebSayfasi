...
{
    public partial class abz : System.Web.UI.Page
    {
        ...
        {
            string MailAdres = txtMail.Text.Trim();
            ...
            if (TestEmailRegex(MailAdres) == true)
            {
                ...
                if (TamDeger == "Başarılı :")
                {
                    ...
                    txtMail.Text = MailAdres + " " + TamDeger + "   " + "Eklendi.";
                }
                else
                {
                    txtMail.Text = MailAdres + " " + TamDeger + "   " + "Eklenemedi.";
                }
            }
            else
            {
                txtMail.Text = MailAdres + " Hatalı Format.";
            }
        }
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sahasatisyazilimi.aspx.cs" Inherits="RomsisWebSayfasi.SahaSatisYazilimi" %>
...
<head runat="server">
    ...
    <title>saha satış sıcak soğuk satış araç içi satış yazılımı</title>
    <meta name="title" content="saha satış sıcak soğuk satış araç içi satış yazılımı" />

    <meta name="Description" content="saha satış sıcak soğuk satış araç içi satış yazılımı" />
    ...
    <meta property="og:title" content="saha satış sıcak soğuk satış araç içi satış yazılımı" />
    <meta property="og:type" content="website" />
    <meta name="theme-color" content="#ff214f" />
    <link rel="canonical" href="sahasatisyazilimi.aspx" />
    <meta property="og:url" content="sahasatisyazilimi.aspx" />
...
<body class="u-body">
                    ...
                    <div class="u-layout-row">
                        ...
                        <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-41 u-layout-cell-2">
                            <div class="u-container-layout u-container-layout-2">
                                <h2 class="u-text u-text-1">Romsis Saha Satış Yazılımı</h2>
                                <p class="u-text u-text-white u-text-2">
                                    Romsis Saha Satış Yazılımı el terminali içinde satışların pratik ve kolay şekilde yapıldığı mobil satış yazılımıdır. Windows masaüstü ve web platformlarındaki uygulama eklentisiyle parametrik yönetim raporlama analiz işlemlerinin rahatlıkla hızlı şekilde yapılmaktadır. Talep edildiği zaman müşterilerimizin kullandığı ticari muhasebe programlarına entegre edilmektedir.Romsis Hızlı Satış Yazılımı Bazı Temel Özelikleri<br />
                                    * Hızlı satış yapabilmek için pratik satış ekranları.<br />
                                    * Ürün en son müşteriye kaç adet ve hangi fiyattan satıldığını görebilme.<br />
                                    * Anlık stok miktarlarını ve satış fiyatlarını kontrol edebilme.<br />
                                    * Ürünler için ortalama ve son tanımlı saın alma fiyatını görebilme.<br />
                                    * Hızlı stok ve cari arama seçenekleriyle kolay kullanım imkanı.<br />
                                    Yaptığımız projelendirme sonrasında müşterimizin ihtiyacı doğrusunda analiz çıkarıyoruz. Analiz sonrasında müşterimizin kullanacağı yazılımı müşterilerimizin iş yapış şekline göre geliştiriyoruz. Yazılımı geliştirmeyi bitirdikten sonra testlerimizi müşterimizle birlikte yapıyoruz. Yani geliştirmemizi müşteri odaklı yapıyoruz. Satış sonrası destek ekibimizle teknik sorunlarında yanındayız.
    ...
    <section class="u-clearfix u-image u-section-6" id="sec-dbf4" data-image-width="1000" data-image-height="647">
        <div class="u-clearfix u-sheet u-sheet-1">
                        ...
                        <div class="u-size-60">
                            <div class="u-layout-row">
                                <div class="u-container-style u-grey-5 u-layout-cell u-right-cell u-size-60 u-layout-cell-1">
                                    <div class="u-container-layout u-valign-top u-container-layout-1">
                                        <asp:Image ID="Image17" runat="server" ImageUrl="images/RomsisSahaSatis.jpg" class="u-expanded-width u-image u-image-round u-radius-50 u-image-1" data-image-width="1020" data-image-height="250" />
